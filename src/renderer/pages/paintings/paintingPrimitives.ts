export const paintingClasses = {
  ...
  panel: 'flex h-full w-[260px] shrink-0 flex-col overflow-hidden border-border-subtle border-e bg-background',
  ...
  panelScroll: '-mx-1 flex min-h-0 flex-1 flex-col gap-4 overflow-y-auto px-1 pe-2',
  historyStrip:
    'flex h-full w-[68px] shrink-0 flex-col gap-2 overflow-y-auto border-border-subtle border-s bg-background px-2 py-3 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden',
  historyAddButton:
  ...
  toolbarWrap: 'absolute top-4 start-4 z-20',
  toolbarRail:
